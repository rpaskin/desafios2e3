...
Exemplo: Dado uma string "AAABBBBCDDDDDDDDDDEEDDDD" como entrada, devolver uma string "A3B4C1D10E2D4", onde cada símbolo do alfabeto é seguido da sua frequência na string. O decodificador
faz o processo contrario.
